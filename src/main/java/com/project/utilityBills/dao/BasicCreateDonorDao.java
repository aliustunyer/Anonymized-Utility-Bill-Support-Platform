...
@Component
public class BasicCreateDonorDao implements CreateDonorDao {
  @Autowired 
  private NamedParameterJdbcTemplate jdbcTemplate;
  
  @Override
  public Donor saveNewDonor(String first_name, String last_name, String email, String password,
        String cell_phone) {
      ...
      return Donor.builder()
          .donor_id(donorId) // Add the auto-generated donor_id here
